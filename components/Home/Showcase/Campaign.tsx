...
const Campaign = () => {
  return (
    <div className="w-full mx-auto flex flex-col sm:flex-row overflow-hidden">
      {/* Image Section */}
      ...
      {/* Content Section */}
      <div className="bg-black w-full sm:w-1/2 flex justify-center items-center text-white px-4 sm:px-6 py-8">
