      ...
      <DropdownMenuContent className="w-56 bg-black text-white border border-gray-700">
        {userMenuItems.map((item, index) => (
          <DropdownMenuItem key={index} asChild>
            <Link
              href={item.href}
              className="cursor-pointer hover:bg-gray-800 px-2 py-2 text-sm">
              {item.title}
            </Link>
          </DropdownMenuItem>
        ))}
  ...
  return (
    <div className="fixed z-50 top-0 w-full bg-black text-white flex flex-wrap justify-between items-center px-4 sm:px-6 py-3 font-manrope">
      ...
      <div className="flex justify-between items-center w-full lg:w-auto">
        {/* Logo */}
        <div className="text-xl sm:text-2xl lg:text-4xl font-serif tracking-wider uppercase">
          R e l a t i o n
        </div>
        ...
        <div className="lg:hidden">
          <Sheet>
            ...
            <SheetContent
              side="right"
              className="w-full sm:w-[400px] bg-black text-white">
              <SheetTitle>
              ...
              <div className="flex flex-col gap-8 mt-8">
                ...
                <div
                  ...
                  onClick={() => setIsCartTableVisible(true)}>
